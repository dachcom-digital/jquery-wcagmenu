...
onLine2:!1};k=(m-f)*(c-a)-(q-d)*(e-b);if(0===k)return p;g=b-f;h=a-d;n=(c-a)*g-(e-b)*h;g=((q-d)*g-(m-f)*h)/k;h=n/k;p.x=a+g*(c-a);p.y=b+g*(e-b);0<g&&1>g&&(p.onLine1=!0);0<h&&1>h&&(p.onLine2=!0);return p},_focus:function(a){d(a.target).is(this.element)&&this._focusMenu()},_blur:function(a){d(a.target).is(this.element)&&this._closeMenu()},_keyevent:function(a){switch(a.keyCode){case this._keys.tab:return this._closeMenu();case this._keys.esc:return this._closeMenu(),this._focusMenu();case this._keys.down:return this._key("down");
case this._keys.up:return this._key("up");case this._keys.left:return this._key("left");case this._keys.right:return this._key("right");case this._keys.space:return this._open("space");case this._keys.enter:return this._action()}},_getLevel:function(a){a=(a.attr("class")||"").match(/level-(\d+)/i);return null===a?0:window.parseInt(a[1],10)},_getCurrentLevel:function(){return this._getLevel(this._currentFocus)},_getSiblings:function(){var a=this._getCurrentLevel();return 1===a?this.element.find(".level-"+
a):this._currentFocus.closest(".level-"+(a-1)).find(".level-"+a)},_open:function(a){var b;b=this._getCurrentLevel();var c=this._currentFocus;b=this._currentFocus.find(".level-"+(b+1)+":first");return b.length?(this._currentFocus.addClass(this.options.classOpen),this._currentFocus=this._addFocus(b),this._trigger("open",{},[c]),!1):"space"===a?this._action():!1},_close:function(){var a;a=this._getCurrentLevel();a=this._currentFocus.closest(".level-"+(a-1));a.length&&(this._currentFocus=a.removeClass(this.options.classOpen),
a.find("."+this.options.classFocus+", ."+this.options.classOpen).removeClass(this.options.classFocus+" "+this.options.classOpen),this._trigger("close",{},[a]));return!1},_action:function(){window.location.href=this._currentFocus.find("a").attr("href");return!1},_key:function(a){var b=this._getCurrentLevel();a=this._currentFocus.data(a)||this.options.controls[b][a];return this["_"+(a||"none")]()},_none:function(){return!1},_left:function(){var a,b;a=this._getSiblings();b=a.index(this._currentFocus);
